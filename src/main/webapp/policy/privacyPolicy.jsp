...
<div class="container py-4">
    ...
    <div class="policy-body" style="max-width: 860px;">
        ...
        <ul>
            ...
            <li>커뮤니티 이용 기록: 작성한 게시글·댓글·좋아요·신고 내역</li>
            <li>장소 등록 신청 시 입력한 주소 및 신청 사유</li>
        </ul>
        ...
        <ul>
            ...
            <li>커뮤니티 게시판, 찜하기 등 부가 서비스 제공</li>
            <li>장소 등록 신청 접수 및 처리</li>
        ...
        <p>서비스 운영자: 차쟁이 운영팀<br>
            이메일: chajjaengi.official@gmail.com</p>
